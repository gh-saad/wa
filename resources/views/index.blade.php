...
<head>
    ...
    <title>whatsApp Busniess API Interface</title>
    <!-- Google Fonts -->
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="send-box">
                                        <form action="{{ url('send') }}" method="post">
                                            @csrf
                                            <input type="hidden" name="to" value="+923102049956">
                                            <input type="text" class="form-control" aria-label="message…" name="body" placeholder="Write message…">
